...
class ExtratorURL:
    ...
    def get_url_base(self):
        ...
        url_base = self.url[:indice_interrogacao] #Antes do : tem um zero (0) e funciona sem ele.
        return url_base
...
if moeda_origem == "real" and moeda_destino == "dolar":
    ...
    print(f"O valor R$ {quantidade} reais é igual a $ {valor_conversao} dolares") 

elif moeda_origem == "dolar" and moeda_destino == "real":
    valor_conversao = int(quantidade) * VALOR_DOLAR
    print(f"O valor de $ {quantidade} dolares é igual a R$ {valor_conversao} reais")
